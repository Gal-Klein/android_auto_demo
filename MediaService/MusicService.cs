...
using MyPodCast.MediaService;

namespace MyPodCast
{
	[Service(Exported = true, Label = "Audioburst Playlist Service", Name = "com.audioburst.playlist.service")]
	...
	{        
        ...
        private AudioProvider _musicProvider;
